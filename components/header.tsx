...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 bg-neutral-50 w-full dark:bg-gray-800 z-50">
      {isWide ? (
        <>
          <nav className="w-full flex lg:flex-row items-center justify-between px-8 py-6 mx-auto">
        ...
        <nav className="w-full flex items-center justify-between px-8 py-6 mx-auto">
